...
import sourabh.pal.movies.common.utils.getProgressBarDrawable
import sourabh.pal.movies.databinding.FragmentSellAppleBinding
...
class SellAppleFragment : Fragment() {
    ...
    private fun handleNavigation(navigateToSuccess: Triple<String, String, String>?) {
        if(navigateToSuccess != null){
            val sellerName = navigateToSuccess.first
            val totalFormattedPrice = navigateToSuccess.second
            val weightInTonnes = navigateToSuccess.third
