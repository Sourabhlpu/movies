...
import sourabh.pal.movies.common.domain.model.seller.DEFAULT_LOYALTY_INDEX
...
data class SellAppleViewState(
    ...
    val navigateOnSuccess: Triple<String, String, String>? = null,
) {
    ...
    fun updateToSuccess(sellerName: String): SellAppleViewState {
        return copy(
            isSubmitting = false,
            navigateOnSuccess = Triple(sellerName, totalPrice, grossWeight.toString())
        )
    }
